...
def kurtosis(d):
    ...
    -------
    Float
        The kurtosis of the distribution of the non-missing data passed using Pearson's definition; calculated as scipy.stats.kurtosis(d, fisher = False, nan_policy = 'omit').'

    """
    return scipy.stats.kurtosis(d, fisher = False, nan_policy = 'omit')
...
def skew(d):
    ...
    -------
    Float
        The skew of the distribution of the non-missing data passed; calculated as scipy.stats.skew(d, nan_policy = 'omit').

    """
    return scipy.stats.skew(d, nan_policy = 'omit')
